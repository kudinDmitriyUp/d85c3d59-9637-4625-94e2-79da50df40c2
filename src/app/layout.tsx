...
export const metadata: Metadata = {
  title: "Coastal Luxury - Beachfront Resort & Ocean View Hotel",
  description: "Experience luxury beachfront living at Coastal Luxury Resort. World-class amenities, ocean views, and unforgettable experiences await.",
  keywords: "luxury resort, beachfront hotel, ocean view rooms, coastal getaway, spa wellness",
  metadataBase: new URL("https://coastalluxuryresort.com"),
  alternates: {
    canonical: "https://coastalluxuryresort.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Coastal Luxury - Beachfront Resort",
    description: "Experience luxury beachfront living with world-class amenities and stunning ocean views",
    type: "website",
    siteName: "Coastal Luxury",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765101226698-ctn4c80d.jpg",
      alt: "Luxury beachfront resort with ocean view"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Coastal Luxury - Beachfront Resort",
    description: "Experience luxury beachfront living at our award-winning resort",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765101226698-ctn4c80d.jpg"]
  }
};
