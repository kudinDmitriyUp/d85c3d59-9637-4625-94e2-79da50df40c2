...
import { Camera, CheckCircle, ConciergeBell, Dumbbell, Gift, Heart, Home, Mail, Sparkles, Spade, Star, TrendingUp, Utensils, Waves } from "lucide-react";
      ...
      <div id="amenities" data-section="amenities">
        <FeatureCardSeventeen
          ...
          features={[
            ...
            { id: "3", icon: Spade, text: "Spa & Wellness" },
            { id: "4", icon: Dumbbell, text: "Fitness Center" },
            { id: "5", icon: Camera, text: "Ocean Activities" },
            { id: "6", icon: ConciergeBell, text: "24/7 Concierge" }
          ]}
          animationType="slide-up"
          variant="card"
